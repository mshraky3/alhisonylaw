export const translations = {
  ar: {
      ...
      items: {
        ...
        criminal: {
          ...
          details: [
            ...
            { label: 'محكمة التنفيذ:', text: 'تنفيذ الاحكام الحقوقية عن طريق الامارة .  تقديم طلبات العفو عن الاحكام الجزائية' }
          ],
        ...
        administrative: {
          ...
          details: [
            ...
            { label: 'محكمة التنفيذ:', text: ' تنفيذ صكوك الأحكام الصادرة من المحكمة الإدارية ضد الجهات الحكومية عن طريق محكمة التنفيذ الإدارية.' }
          ],
        ...
        appeal: {
          ...
          details: [
            ...
            { label: 'تقديم اللوائح وكتابة مذكرات الاعتراض.',  }
          ],
        ...
        supreme: {
          ...
          details: [
            ...
            { label: 'تقديم اللوائح وكتابة مذكرات النقض.',   }
          ],
      ...
      items: {
        ...
        documentation: {
          ...
          items: [
            ...
            '<strong>الأحوال الشخصية:</strong> توثيق عقود الزواج والطلاق والخلع والرجعة '
          ],
        ...
        execution: {
          ...
          items: [
            ...
            'المنازعة على طلب التنفيذ أو تقديم طعن على طلب التنفيذ',
    ...
    contact: {
      ...
      riyadhOffice: 'فرع الرياض',
      qassimOffice: 'فرع القصيم',
